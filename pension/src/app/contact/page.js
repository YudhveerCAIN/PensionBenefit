          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-semibold text-lg"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:hello@pensionplannerpro.com" className="text-green-600 hover:text-green-700">
                        hello@pensionplannerpro.com
                      </a>
                      <br />
